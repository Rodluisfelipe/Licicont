    ...
    <AnimatePresence>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`btn btn-whatsapp ${
                inDiagnostic ? 'flex-1 py-3.5' : 'h-[46px] w-[46px] shrink-0 px-0'
              }`}
            >
      ...
      {visible && (
        <motion.a
          ...
          aria-label="Escríbeme por WhatsApp"
          className="btn btn-whatsapp group fixed right-6 bottom-6 z-40 hidden rounded-full py-3.5 pr-5 pl-4 md:inline-flex"
        >
          <MessageCircle className="h-5 w-5" />
